...
|-|-|-|
|[Стоимост кваритир](https://github.com/plaxin-i/research_of_apartment_sale_ads)|Анализ параметров и их влияние на стоимость квартир в Санкт-Петербурге и области|pandas, numpy, stats, matplotlib, seaborn, scikit-learn|
<!--
